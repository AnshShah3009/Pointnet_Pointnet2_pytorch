...
# %%
path = Path("/scratch/ansh/ModelNet40")
...
if os.path.exists('./log/PointNet/checkpoints/modelnet40_cls.pth'):
    pointnet.load_state_dict(torch.load('./log/PointNet/checkpoints/modelnet40_cls.pth'))
    print('Loaded Pre-trained PointNet Model!')

# %%
optimizer = torch.optim.Adam(pointnet.parameters(), lr=0.08)
...
def train(model, train_loader, val_loader=None,  epochs=10):
    for epoch in range(epochs): 
        ...
        # save the model
        torch.save(pointnet.state_dict(), "./log/PointNet/checkpoints/modelnet40_cls.pth")
